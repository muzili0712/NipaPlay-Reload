...
class _LiquidDashboardHomePageState extends State<LiquidDashboardHomePage>
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    _liquidHeroGradientStart,
                    _liquidHeroGradientEnd,
                  ],
  ...
  Widget _buildGradientPlaceholder() {
    return Container(
      decoration: BoxDecoration(
        gradient: _liquidPlaceholderGradient,
      ),
    );
  }
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      _liquidPrimaryTextColor.withOpacity(0.08),
                      _liquidPrimaryTextColor.withOpacity(0.15),
                    ],
                  ),
                ),
              ),
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _liquidPrimaryTextColor
                              .withOpacity(_liquidIsDark ? 0.8 : 0.5),
                          width: 1,
                        ),
                      ),
                      child: Row(
                ...
                errorBuilder: (context, error) => Container(
                  ...
                  child: Center(
                    child: Icon(Icons.broken_image,
                        color: _liquidTextColor(0.3), size: 16),
                  ),
                ),
              )
            else
          ...
          final thumbnailWidget = FutureBuilder<Uint8List>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return Container(color: _liquidQuickActionBackground);
              }
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: isSelected
                            ? _liquidPrimaryTextColor
                            : (isHovered
                                ? _liquidTextColor(0.8)
                                : _liquidTextColor(0.5)),
                      ),
                    ),
                  ),
                );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: enabled
                  ? _liquidPrimaryTextColor
                      .withOpacity(_liquidIsDark ? 0.3 : 0.18)
                  : _liquidPrimaryTextColor
                      .withOpacity(_liquidIsDark ? 0.18 : 0.1),
              width: 1,
            ),
          ),
          child: Material(
  ...
  bool get _liquidIsDark => Theme.of(context).brightness == Brightness.dark;

  Color get _liquidPrimaryTextColor =>
      _liquidIsDark ? Colors.white : Colors.black;
